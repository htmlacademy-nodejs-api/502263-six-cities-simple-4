...
export function createError(serviceError: ServiceError, message: string, details: ValidationErrorField[] = []) {
  return {
...
export async function createJWT(algorithm: string, jwtSecret: string, payload: object): Promise<string> { // TODO вместо object передать конкретный тип types/tokenPayload.type ?
